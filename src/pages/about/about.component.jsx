  ...
  <div className="about">
    <section className="about__hero">
      ...
      <p className="hero__content">
        ...
        business operations. We provide the needed efficiencies to small/medium
        sized companies to help them stay competitive with the big players and
        offer robust solutions for larger companies with high shipment volumes,
        rapid transaction traffic, and users in different countries, time zones
        and currencies.
      </p>
    ...
    <section className="about__founders">
      ...
      <div className="founders__tiles">
        <div className="founder__content">
          ...
          <p>
            In the early beginnings of Magaya in 1999, he started by coding the
            first release of the software and lead the engineering team for
            several years. As the company has grown, he has helped build each
            department and put together the solid management team that leads
            them.
          </p>
          <p>
        ...
        <div className="founder__content">
          ...
          <p>
            In 2000, he moved to the United States to pursue the “Magaya” dream
            with his Co-CEOs and dedicates his time to building the Magaya brand
            and delivering software products and services that can solve complex
            problems for diverse customers in the Supply Chain industry.
          </p>
        </div>
        <div className="founder__content">
          <img
          ...
          <p>
            Gabriel studied medical science at Miami-Dade Community College and
            the University of South Florida. His parents had hoped he’d become a
            physician, but he sidestepped medical school at the last minute and
            set his eyes on developing a winning business.
          </p>
          <p>
            ...
            strong relationships in the logistics community. Gabriel later went
            on to become the Director of Logistics for eCaravan.com, a Silicon
            Valley based startup focused on B2B transactions between North and
            South America.
          </p>
        </div>
      </div>
